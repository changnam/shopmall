...
public abstract class ComputerDetailMapper {
	...
	public abstract ComputerDetail toEntity(ComputerDetailDto computerDetailDto);
    ...
    @AfterMapping
	protected void afterToEntity(ComputerDetailDto computerDetailDto, @MappingTarget ComputerDetail computerDetail) {
