...
public abstract class ProductDetailMapper {
	...
	@Named("toEntity")
	public abstract ProductDetail toEntity(ProductDetailDto productDetailDto, @Context MappingContext context);
...
//	public abstract List<ProductDetail> toEntityList(List<ProductDetailDto> productDetailDtos);
	...
	@AfterMapping
	protected void afterToEntity(ProductDetailDto productDetailDto, @Context MappingContext context,
